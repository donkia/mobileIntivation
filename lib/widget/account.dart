...
class _AccountState extends State<Account> {
  ...
  Widget build(BuildContext context) {
    analytics
        .logEvent(name: 'page_view', parameters: {'page_name': 'account_page'});
    return Padding(
        ...
        SizedBox(
          ...
          child: OutlinedButton(
            onPressed: () {
              analytics.logEvent(
                  name: 'button_click',
                  parameters: {'button_name': '[버튼] 신랑측 계좌번호'});
                    ...
                    IconButton(
                        onPressed: () {
                          analytics.logEvent(name: 'button_click', parameters: {
                            'button_name': '[버튼] copy 신랑 아버지 계좌번호'
                          });
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                        onPressed: () {
                          analytics.logEvent(name: 'button_click', parameters: {
                            'button_name': '[버튼] copy 신랑 어머니 계좌번호'
                          });
        ...
        SizedBox(
          ...
          child: OutlinedButton(
            onPressed: () {
              analytics.logEvent(
                  name: 'button_click',
                  parameters: {'button_name': '[버튼] 신부측 계좌번호'});
              setState(() {
                  ...
                  children: [
                    ...
                    IconButton(
                        onPressed: () {
                          analytics.logEvent(
                              name: 'button_click',
                              parameters: {'button_name': '[버튼] copy 신부 계좌번호'});
                          Clipboard.setData(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                        onPressed: () {
                          analytics.logEvent(name: 'button_click', parameters: {
                            'button_name': '[버튼] copy 신부 아버지 계좌번호'
                          });
                          Clipboard.setData(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                        onPressed: () {
                          analytics.logEvent(name: 'button_click', parameters: {
                            'button_name': '[버튼] copy 신부 어머니 계좌번호'
                          });
                          Clipboard.setData(
